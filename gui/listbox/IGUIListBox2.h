// by tom_gamer
// changed to IGUIListBox2 by Nic Anderson
...
#ifndef __I_GUI_LIST_BOX2_H_INCLUDED__
#define __I_GUI_LIST_BOX2_H_INCLUDED__
...
namespace gui
{
	...
	*/
	class IGUIListBox2 : public IGUIElement
	{
	public:
		//! constructor
		IGUIListBox2(IGUIEnvironment* environment, IGUIElement* parent, s32 id, core::rect<s32> rectangle)
		...
		virtual u32 addItem(const wchar_t* text, s32 icon, IReferenceCounted* data) = 0; // changed by Nic Anderson
		...
		virtual void getSelected(core::array<s32> &sel) = 0;

		//! sets the selected item. Set this to -1 if no item should be selected
		virtual void setSelected(s32 index) = 0;

		//! sets the selected items.
		virtual void setSelected(core::array<u32> sel) = 0;
		...
		virtual void setItem(u32 index, const wchar_t* text, s32 icon, IReferenceCounted* data) = 0; // changed by Nic Anderson

		//! Insert the item at the given index
		/** \return The index on success or -1 on failure. */
		virtual s32 insertItem(u32 index, const wchar_t* text, s32 icon, IReferenceCounted* data) = 0; // changed by Nic Anderson
