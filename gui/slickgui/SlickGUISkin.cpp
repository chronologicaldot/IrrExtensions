	...
	, VideoDriver(environment->getVideoDriver())
{
	...
	if ( startIconsFromZero ) {
		...
		Icons[EGDI_CURSOR_UP] = 4;
		Icons[EGDI_CURSOR_DOWN] = 5;
		Icons[EGDI_CURSOR_LEFT] = 6;
		Icons[EGDI_CURSOR_RIGHT] = 7;
		Icons[EGDI_MENU_MORE] = 8;
		Icons[EGDI_CHECK_BOX_CHECKED] = 9;
		Icons[EGDI_DROP_DOWN] = 10;
		Icons[EGDI_SMALL_CURSOR_UP] = 11;
		Icons[EGDI_SMALL_CURSOR_DOWN] = 12;
		Icons[EGDI_RADIO_BUTTON_CHECKED] = 13;
		Icons[EGDI_MORE_LEFT] = 14;
		Icons[EGDI_MORE_RIGHT] = 15;
		Icons[EGDI_MORE_UP] = 16;
		Icons[EGDI_MORE_DOWN] = 17;
		Icons[EGDI_WINDOW_RESIZE] = 18;
