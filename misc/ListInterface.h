...
public:
	...
	//! Obtain item
	/* Returns the object. */
	virtual T& operator[] ( stds32 index )=0;
	
	//! Obtain item
	/* Returns the object. */
	virtual T& get( stds32 index )=0;
	
	//! Set item
	/* Sets the item at the given index. */
	virtual void set( stds32 index, T item )=0;
	
	//! Insert
	/* Adds an item to the list at the given index. */
	virtual void insert( stds32 index, T item )=0;

	//! Erase
	/* Removes an item from the list. */
	virtual void erase( stds32 index )=0;
