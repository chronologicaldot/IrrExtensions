...
#ifndef __IRR_FILE_INPUT_STREAM__
#define __IRR_FILE_INPUT_STREAM__

//! Cass Irr File Input Stream
/* This type of stream is specifically designed to convert a text
file to standard characters and then to a list of accessible tokens. */
class IrrFileInputStream, public InputStream
{
public:
	//! constructor
	IrrFileInputStream()
	...
	*/
	...
	// ******** Unique functions **********
		...
		//! Set file and read
	/* This sets the file to read from and then proceeds to read it.
	Note that calling this function removes all data from the previous
	file stored here. */
	void setFileAndRead( irr::io::IReadFile* file );

};

#endif // #define __IRR_FILE_INPUT_STREAM__