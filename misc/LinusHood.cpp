...
template<class T>
class LinusHood : public ListInterface<T>
{
	LListix<T> list;

public:
	LinusHood<T>() : ListInterface<T>()
	{
	}
	...
	void insert( stds32 index, T item )
	{
